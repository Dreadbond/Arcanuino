...
if (rssi[rssiIndex] != analogRead(rssi_pin) ){
  ...
  for (int i=0 ; i<sz ; i++)  {
      //Serial.print(rssi[i]);  Serial.println();//(" ");
      if (rssi[i] > seuil) {
        rssiTotal += rssi[i] ;
        rssiIndexTotal++ ;
        }
    ...
    rssiTotal /= rssiIndexTotal ;
    

    //Serial.println(rssiTotal) ;
    //Serial.println("!");
    //Serial.println(rssiIndexTotal) ;
rssiIndexTotal = 1;
...
//Serial.print(rssi[rssiIndex]) ;Serial.print(" ") ;

/*
Serial.print(rssi_score_1); Serial.print(" ");
Serial.print(rssi_score_2); Serial.print(" ");
