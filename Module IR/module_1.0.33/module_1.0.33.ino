...
attaque2Cap[3] = anS ;
attaque2Cap[4] = auS ;
Serial.print(attaque2Cap[0]);
Serial.print("p ");
Serial.print(attaque2Cap[1]);
Serial.print("i ");
Serial.print(attaque2Cap[2]);
Serial.print("m ");
Serial.print(attaque2Cap[3]);
Serial.print("an ");
Serial.print(attaque2Cap[4]);
Serial.println("au ATTAQUE 2");
delay (1000);
digitalWrite(ledAtt, LOW);
digitalWrite(Led13, LOW);
  break;
...
if (pS <= attaque2Cap[0] + marge 
&& pS >= attaque2Cap[0] - marge 
&& iS <= attaque2Cap[1] + marge 
&& iS >= attaque2Cap[1] - marge 
&& mS <= attaque2Cap[2] + marge  
&& mS >= attaque2Cap[2] - marge 
&& anS <= attaque2Cap[3] + marge 
&& anS >= attaque2Cap[3] - marge 
&& auS <= attaque2Cap[4] + marge 
&& auS >= attaque2Cap[4] - marge 
&& temps > Cible2  
)  
{
...
if (pS <= attaque2Capb[0] + marge 
&& pS >= attaque2Capb[0] - marge 
&& iS <= attaque2Capb[1] + marge 
&& iS >= attaque2Capb[1] - marge 
&& mS <= attaque2Capb[2] + marge  
&& mS >= attaque2Capb[2] - marge 
&& anS <= attaque2Capb[3] + marge 
&& anS >= attaque2Capb[3] - marge 
&& auS <= attaque2Capb[4] + marge 
&& auS >= attaque2Capb[4] - marge
&& temps > Cible2  
)  
{
...
if (pS <= attaque2Capt[0] + marge 
&& pS >= attaque2Capt[0] - marge 
&& iS <= attaque2Capt[1] + marge 
&& iS >= attaque2Capt[1] - marge 
&& mS <= attaque2Capt[2] + marge  
&& mS >= attaque2Capt[2] - marge 
&& anS <= attaque2Capt[3] + marge 
&& anS >= attaque2Capt[3] - marge 
&& auS <= attaque2Capt[4] + marge 
&& auS >= attaque2Capt[4] - marge 
&& temps > Cible2 
)  
{
...
digitalWrite(ledAtt, LOW);
digitalWrite(Led13, LOW);
if (Cible2 < temps )      {   digitalWrite(ledAtt2, HIGH);  }
else if (Cible2 >= temps ){   digitalWrite(ledAtt2, LOW);   }
