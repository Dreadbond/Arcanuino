...
///////////////////////////////////////////////////////////////
  ...
  if (buttonState1 == HIGH && Temps > Cible2 ) {soinsSend();}           // bouton 1 : lumière et envoi "soins"
  if (buttonState2 == HIGH && Temps > Cible1 ) {attaqueSend();}           // bouton 2 : lumière et envoi 20 dégâts si pas en cooldown
...
health = 100 ;
       ...
       if (message == 2832 && health > 0) {attaqueRcv();}    //b10 2832 : dégâts 

       if (message == 2576 && health < 100) {soinsRcv();}    //a10 2576 soins
