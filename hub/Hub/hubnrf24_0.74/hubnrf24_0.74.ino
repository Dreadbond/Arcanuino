...
void setup()
{
  ...
  //Serial.print("Hub NRF24. 0.73 ajout Json Tag : "); Serial.println(IDObject);
  pinMode(2, OUTPUT);
  digitalWrite(2, LOW);
...
void loop(){
  ...
  if (Serial.available()) 
  {
char receivedFeedback = Serial.read();
/*
  StaticJsonBuffer<100> jsonBuffer;
  JsonObject& root = jsonBuffer.createObject();

root["to"] = receivedFeedback      ;
root["from"] = receivedFeedback.from    ;
root["param"] = receivedFeedback.param  ;
root["value"] = receivedFeedback.value   ;
  ...
  Serial.println();
    */
    ...
    //{ to: '!111111', from: ':pistol', param: 'trigger', value: 0 }
  }
