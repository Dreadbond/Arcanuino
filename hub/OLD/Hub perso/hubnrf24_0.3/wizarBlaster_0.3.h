...
void wizarBlasterCode(String param, float value){

        if (param == "trigger"){Serial.println("Trigger demande");}
        if (param == "reload") {Serial.println("Rechargement demande");}
        if (param == "nxtMode"){Serial.println("Next mode demande");}
