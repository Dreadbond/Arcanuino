...
void gantCode(String param, float value){
        if (param == "x") {donneesGant.x = value;}
        if (param == "y") {donneesGant.y = value;}
        if (param == "z") {donneesGant.z = value;}

        if (param == "p") {donneesGant.p = value;}
        if (param == "i") {donneesGant.i = value;}
        if (param == "m") {donneesGant.m = value;}
        if (param == "an") {donneesGant.an= value;}
        if (param == "au") {donneesGant.au= value; printGloveData();}
        if (param == "cible")  {Serial.println("Cible demandee");}
