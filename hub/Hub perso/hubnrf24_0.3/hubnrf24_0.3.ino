...
String RecToString = String(receiveBox.from) ;    //pour aussi remettre à 0 la receiveBox
String RecParamString=String(receiveBox.param);

if (RecToString == ":wizbla") {wizarBlasterCode(RecParamString, receiveBox.value);}
if (RecToString == ":pistol") {flingueCode(RecParamString, receiveBox.value);}
if (RecToString == ":gant")   {gantCode(RecParamString, receiveBox.value);}
