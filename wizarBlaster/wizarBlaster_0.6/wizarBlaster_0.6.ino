...
void chargedFireFB(){
  ...
  static float bright ;
  static int TC0 = 0 ;
  static int TC1 = TC0 + 2250 ;
  static int TC2 = TC1 + 50 ;
  static int TC3 = TC2 + 20 ;
  static int TC4 ;
...
void setup()
{
  ...
  Serial.println("WizarBlaster 0.6");
}
...
//détection Ir : faisage de message
  if (irrecv.decode(&results)) {
     ...
     if (char(results.value) == '!') {write_message = HIGH;}
        ...
        posCharRcv++ ;
        resetCible = millis() + 100;                    //délai avant perte de cible : 150
