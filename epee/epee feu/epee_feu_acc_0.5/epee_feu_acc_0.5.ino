...
{ 
  ...
  Serial.begin(9600); 
  Serial.println("Epee de feu V0.5");
...
void sendCoup(int puissance) {
  ...
  //msg[6] = count;
  //const char *msg = "Coup d'epee ! Degats :";
  char msg[25]= "Coup d'epee ! Degats :";
  Serial.print(msg);
  Serial.println(puissance);
  msg[22] = puissance ;
  //msg[23] = ".";
  digitalWrite(13, HIGH); // Flash a light to show transmitting
  vw_send((uint8_t *)msg, 25); //strlen(msg) + x
...
if (nextRefresh < millis() ){
  ...
  if (diffy > 200) {
    ...
    strip.setPixelColor(i, red+50, green+50, blue+50); }
    nextRefresh = millis() + 200 ;
    sendCoup(diffy);
  }
...
Serial.print(diffy); Serial.print(" "); Serial.print(j); Serial.print(" "); Serial.println(squrt);
*/
