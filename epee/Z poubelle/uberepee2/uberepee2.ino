...
int currentChore[] ;    // modifier la taille au fur et à mesure

int currentGeste ;
int gTaille1 = 1 ;  //taille D G
int gTaille2 = 2 ;  //taille G D
int estoc1 = 3 ;    //estoc
int droit1 = 4 ;    //pourfendre
int moulinet1 = 5 ;  //moulinet D
int moulinet2 = 6 ;  //moulinet G

*/

/*
if (currentGeste != 0) {  
  currentChore[i] = currentGeste ;  
  }



char att1[geste1, geste3, geste2] ;

if (currentChore[] == combo1[] ) {sort1();}
if (currentChore[] == combo2[] ) {sort2();}
if (currentChore[] == combo3[] ) {sort3();}
if (currentChore[] == combo4[] ) {sort4();}
if (currentChore[] == combo5[] ) {sort5();}


if (time() > reset) {currentChore[] = {} ;}
