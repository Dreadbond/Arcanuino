...
void setup()
{
  ...
  Serial.println("Flingue 0.3 avec RF24");
}
...
if (String(receiveBox.value).equals("trigger") && process) {;shootFbToken=1; process=0;}
if (shootFbToken) {shootFb();}

/*
if (mireCible) {
    digitalWrite(A2, HIGH);
    if (sendBox.targetBool) {stripCanon.setPixelColor(0, 0, 100, 0); stripCanon.show();}
  }
  else
  {
    digitalWrite(A2, LOW);
    if (!sendBox.targetBool) {stripCanon.setPixelColor(0, 0, 0, 0); stripCanon.show();}
  }*/
...
/*
void contenusendBox(){
  Serial.print(sendBox.to); Serial.print(" ");
  Serial.print(sendBox.from); Serial.print(" ");
  Serial.print(sendBox.target); Serial.print(" ");
  Serial.print(sendBox.value); Serial.print(" ");
  Serial.print(sendBox.rssi); Serial.print(" ");
  Serial.print(sendBox.targetBool); Serial.print(" ");
  Serial.print(sendBox.trigger); Serial.print(" ");
  Serial.println();
}
*/
